...
public class MovieWidget extends AppWidgetProvider {
    ...
    public static final String TOAST_ACTION = "com.erdian.app.cataloguemovie.TOAST_ACTION";
    public static final String EXTRA_ITEM = "com.erdian.app.cataloguemovie.EXTRA_ITEM";
